...
let year = d.getFullYear();
  ...
  <div>
    <div className='-mt-1  bg-[#f5f2f2]'>
      <svg xmlns="http://www.w3.org/2000/svg" height="18px" width="100%" viewBox="0 0 1047.1 3.7" preserveAspectRatio="xMidYMin slice">
    ...
    <div className=" flex py-12  px-4 justify-evenly  max-lg:gap-4 flex-wrap bg-[#f5f2f2] text-slate-600 ">
      <div className="w-[20rem] pr-4 ">
        <div className='-ml-8'><Image src="/CraftIndika.png" width={320} height={300} placeholder='blure'/></div>
      ...
      <div className="w-[12rem] max-sm:w-[7rem]">
        ...
        <ul className=" flex text-sm flex-col font-semibold gap-1 ">
          ...
          <li className='hover:text-[var(--color-default)] duration-150'><a href="#">Cancellation & Returns</a></li>
          <li className='hover:text-[var(--color-default)] duration-150'><a href="#">Disclaimer</a></li>
        </ul>
      </div>
